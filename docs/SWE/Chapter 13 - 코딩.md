...
- 정보 제공 기관에 따라 다름
	...
	- FOLDOC: 1000개
	- HOPL: 8,945개
- 주로 사용하는 상용 언어의 갯수는 20~30
- 특정 분야에서 쓰이는 언어까지 포함: 100종 이상

- 최초의 고급 프로그래밍 언어는 Plankalikul(플랭칼쿨)
	- 당시 구동되는 실물 컴퓨터는 존재하지 않아 종이로 제안
	- 최초의 상용 고급 프로그래밍 언어는 포트란
...
#### 2. 아키텍처를 우선 개발하라
- 아키텍처의 설계가 없는 상황에서 코드를 작성하면 코드의 구조적인 문제로 어려움을 격을 수 있다.
...
- 코드내 결합뿐만 아니라 서버간의 결합이나 응집력을 고려할 필요가 있다.
